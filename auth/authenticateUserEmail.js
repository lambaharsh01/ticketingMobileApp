import {View, Image, ActivityIndicator, TextInput, Text, BackHandler, StyleSheet, Pressable, Alert } from 'react-native';
...
function saveBasicDetails(){
  ...
  axios.put( baseUri+'/api/user/addUserDetails/'+userEmail, {gender, district, dateOfBirth:formatDate(dateOfBirth)})
  .then((res)=>{
